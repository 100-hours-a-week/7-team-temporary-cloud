 ...
 */
export const BASE_URL = 'http://54.180.148.88:8080' //'http://localhost:8080';
...
export const LOAD_TEST_STAGES = [
    { duration: '5s', target: 5 },   // Ramp-up: 10 VU까지 증가
    { duration: '5s', target: 10 },   // Steady: 20 VU 유지
    { duration: '5s', target: 20 },   // Scale-up: 30 VU까지 증가
    { duration: '5s', target: 15 },  // Ramp-down 시작
    { duration: '5s', target: 10 },
    { duration: '5s', target: 5 }   // Ramp-down: 0으로 감소 (깔끔한 종료)
];

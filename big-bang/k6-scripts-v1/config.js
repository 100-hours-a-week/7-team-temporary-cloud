 ...
 */
export const BASE_URL = 'http://3.35.175.6:8080' //'http://localhost:8080';
...
export const LOAD_TEST_STAGES = [
    { duration: '2m', target: 30 },   // Ramp-up: 2분간 50 VU까지 증가
    { duration: '5m', target: 40 },   // Steady: 5분간 50 VU 유지
    { duration: '10m', target: 50 },  // Scale-up: 2분간 100 VU까지 증가
    { duration: '5m', target: 40 },  // Steady: 5분간 100 VU 유지
    { duration: '1m', target: 0 },    // Ramp-down: 1분간 0으로 감소
];
